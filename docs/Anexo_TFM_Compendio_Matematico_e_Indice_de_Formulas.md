...
Como culminación empírica y tangible de la investigación, la arquitectura tecnológica diseñada se materializa en una **Torre de Control interactiva en tiempo real** implementada en **Streamlit** ([src/visualization/dashboard.py](file:///d:/LabD/DS-LOGISTICA%204.0-Metro-Meals-on%20Wheels%20Treasure%20Valley/src/visualization/dashboard.py)) y respaldada por un ecosistema de gobernanza **MLflow** y orquestación de contenedores.

El inventario global e interconexión con el código fuente y datos se encuentra formalizado en el [**Catálogo Maestro de Artefactos del Proyecto**](file:///d:/LabD/DS-LOGISTICA%204.0-Metro-Meals-on%20Wheels%20Treasure%20Valley/docs/Catalogo_Maestro_Artefactos_Proyecto.md). La siguiente tabla resume la correlación entre cada módulo funcional, su script principal y la evidencia gráfica correspondiente:

| Módulo de la Plataforma | Denominación Funcional | Script Fuente | Evidencia Visual del Artefacto |
| :--- | :--- | :--- | :---: |
| **Módulo 1** | Torre de Control Telemática en Tiempo Real (GPS & IoT) | [`src/visualization/dashboard.py`](file:///d:/LabD/DS-LOGISTICA%204.0-Metro-Meals-on%20Wheels%20Treasure%20Valley/src/visualization/dashboard.py) | [Sección E.1](#e1-módulo-1-torre-de-control-telemática-y-despacho-en-tiempo-real-gps--streaming-iot) |
| **Módulo 2** | Planificación de Despacho Activo y Consola Capa Gold | [`src/processing/feature_store.py`](file:///d:/LabD/DS-LOGISTICA%204.0-Metro-Meals-on%20Wheels%20Treasure%20Valley/src/processing/feature_store.py) | [Sección E.2](#e2-módulo-2-planificación-de-despacho-activo-y-consola-de-la-capa-gold-feature-store) |
| **Módulo 3** | Motor XAI (TreeSHAP) y Prescripción Guarded GenAI | [`src/decision_engine/shap_explainer.py`](file:///d:/LabD/DS-LOGISTICA%204.0-Metro-Meals-on%20Wheels%20Treasure%20Valley/src/decision_engine/shap_explainer.py) | [Sección E.3](#e3-módulo-3-motor-de-explicabilidad-causal-treeshap-y-prescripción-asistida-guarded-genai) |
| **Módulo 4** | Optimizador de Rutas Last-Mile (2-Opt TSP & SLA Térmico) | [`src/decision_engine/route_optimizer.py`](file:///d:/LabD/DS-LOGISTICA%204.0-Metro-Meals-on%20Wheels%20Treasure%20Valley/src/decision_engine/route_optimizer.py) | [Sección E.4](#e4-módulo-4-optimizador-de-rutas-last-mile-heurística-2-opt-vrp-y-control-de-sla-térmico) |
| **Módulo 5** | Inteligencia Histórica y Analítica Batch Multi-Factorial | [`src/analytics/amazon_eda_deep_dive.py`](file:///d:/LabD/DS-LOGISTICA%204.0-Metro-Meals-on%20Wheels%20Treasure%20Valley/src/analytics/amazon_eda_deep_dive.py) | [Sección E.5](#e5-módulo-5-inteligencia-histórica-y-analítica-batch-impacto-climático-dispersión-y-correlaciones) |
| **Módulo 6** | Módulo EDA, Estadística Descriptiva y Normalidad | [`src/analytics/statistical_eda.py`](file:///d:/LabD/DS-LOGISTICA%204.0-Metro-Meals-on%20Wheels%20Treasure%20Valley/src/analytics/statistical_eda.py) | [Sección E.6](#e6-módulo-6-módulo-eda-estadística-descriptiva-y-evaluación-de-normalidad) |
| **Módulo 7** | Inferencia Estadística Formal y Contraste de Hipótesis | [`src/analytics/statistical_eda.py`](file:///d:/LabD/DS-LOGISTICA%204.0-Metro-Meals-on%20Wheels%20Treasure%20Valley/src/analytics/statistical_eda.py) | [Sección E.7](#e7-módulo-7-inferencia-estadística-formal-y-contraste-de-hipótesis-operacionales) |
| **Módulo 8** | Plataforma MLOps, Registro de Modelos y Curvas MLflow | [`src/models/train.py`](file:///d:/LabD/DS-LOGISTICA%204.0-Metro-Meals-on%20Wheels%20Treasure%20Valley/src/models/train.py) | [Sección E.8](#e8-módulo-8-plataforma-mlops-registro-de-experimentos-curvas-de-desempeño-y-gobernanza-en-mlflow) |
